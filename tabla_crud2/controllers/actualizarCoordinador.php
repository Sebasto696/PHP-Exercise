...
$sql="SELECT * FROM coordinador WHERE cod_estudiante='$id'";
...
<html lang="en">
    ...
    <body class="bg-dark">
                <div class="container mt-5">
                    <form action="/tabla_crud2/controllers/updateCoordinador.php" method="POST">
                            ...
                            <a href="/tabla_crud2/views/coordinador.php" class="btn btn-danger">Regresar</a>
                    </form>
