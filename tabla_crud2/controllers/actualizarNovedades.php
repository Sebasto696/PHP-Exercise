...
$sql="SELECT * FROM novedad WHERE id='$id'";
...
<html lang="en">
    ...
    <body class="bg-dark">
                <div class="container mt-5">
                    <form action="/tabla_crud2/controllers/updateNovedades.php" method="POST">
                            ...
                            <a href="/tabla_crud2/views/novedades.php" class="btn btn-danger">Regresar</a>
                    </form>
